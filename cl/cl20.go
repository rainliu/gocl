...
const (
	...
	CL_INVALID_PIPE_SIZE               = C.CL_INVALID_PIPE_SIZE
	CL_INVALID_DEVICE_QUEUE            = C.CL_INVALID_DEVICE_QUEUE

	/* OpenCL Version */
	CL_VERSION_1_0 = C.CL_VERSION_1_0
	CL_VERSION_1_1 = C.CL_VERSION_1_1
	CL_VERSION_1_2 = C.CL_VERSION_1_2
	CL_VERSION_2_0 = C.CL_VERSION_2_0
	...
	CL_DEVICE_QUEUE_ON_HOST_PROPERTIES      CL_device_info = C.CL_DEVICE_QUEUE_ON_HOST_PROPERTIES
	...
	CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS            CL_device_info = C.CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS
	CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE             CL_device_info = C.CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE
	CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES           CL_device_info = C.CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES
	CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE       CL_device_info = C.CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE
	CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE             CL_device_info = C.CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE
	CL_DEVICE_MAX_ON_DEVICE_QUEUES                 CL_device_info = C.CL_DEVICE_MAX_ON_DEVICE_QUEUES
	CL_DEVICE_MAX_ON_DEVICE_EVENTS                 CL_device_info = C.CL_DEVICE_MAX_ON_DEVICE_EVENTS
	CL_DEVICE_SVM_CAPABILITIES                     CL_device_info = C.CL_DEVICE_SVM_CAPABILITIES
	CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE CL_device_info = C.CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE
	CL_DEVICE_MAX_PIPE_ARGS                        CL_device_info = C.CL_DEVICE_MAX_PIPE_ARGS
	CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS         CL_device_info = C.CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS
	CL_DEVICE_PIPE_MAX_PACKET_SIZE                 CL_device_info = C.CL_DEVICE_PIPE_MAX_PACKET_SIZE
	CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT  CL_device_info = C.CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT
	CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT    CL_device_info = C.CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT
	CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT     CL_device_info = C.CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT
	...
	CL_QUEUE_ON_DEVICE                     CL_command_queue_properties = C.CL_QUEUE_ON_DEVICE
	CL_QUEUE_ON_DEVICE_DEFAULT             CL_command_queue_properties = C.CL_QUEUE_ON_DEVICE_DEFAULT
	...
	CL_DEVICE_SVM_COARSE_GRAIN_BUFFER CL_device_svm_capabilities = C.CL_DEVICE_SVM_COARSE_GRAIN_BUFFER
	CL_DEVICE_SVM_FINE_GRAIN_BUFFER   CL_device_svm_capabilities = C.CL_DEVICE_SVM_FINE_GRAIN_BUFFER
	CL_DEVICE_SVM_FINE_GRAIN_SYSTEM   CL_device_svm_capabilities = C.CL_DEVICE_SVM_FINE_GRAIN_SYSTEM
	CL_DEVICE_SVM_ATOMICS             CL_device_svm_capabilities = C.CL_DEVICE_SVM_ATOMICS
	...
	CL_QUEUE_SIZE            CL_command_queue_info = C.CL_QUEUE_SIZE
	...
	CL_sRGB          CL_channel_order = C.CL_sRGB
	CL_sRGBx         CL_channel_order = C.CL_sRGBx
	CL_sRGBA         CL_channel_order = C.CL_sRGBA
	CL_sBGRA         CL_channel_order = C.CL_sBGRA
	CL_ABGR          CL_channel_order = C.CL_ABGR
	...
	CL_MEM_OBJECT_PIPE           CL_mem_object_type = C.CL_MEM_OBJECT_PIPE
	...
	CL_MEM_USES_SVM_POINTER     CL_mem_info = C.CL_MEM_USES_SVM_POINTER
	...
	/* cl_pipe_info */
	CL_PIPE_PACKET_SIZE CL_pipe_info = C.CL_PIPE_PACKET_SIZE
	CL_PIPE_MAX_PACKETS CL_pipe_info = C.CL_PIPE_MAX_PACKETS
	...
	CL_SAMPLER_MIP_FILTER_MODE   CL_sampler_info = C.CL_SAMPLER_MIP_FILTER_MODE
	CL_SAMPLER_LOD_MIN           CL_sampler_info = C.CL_SAMPLER_LOD_MIN
	CL_SAMPLER_LOD_MAX           CL_sampler_info = C.CL_SAMPLER_LOD_MAX
	...
	CL_PROGRAM_BUILD_GLOBAL_VARIABLE_TOTAL_SIZE CL_program_build_info = C.CL_PROGRAM_BUILD_GLOBAL_VARIABLE_TOTAL_SIZE
	...
	CL_KERNEL_ARG_TYPE_PIPE     CL_kernel_arg_type_qualifier = C.CL_KERNEL_ARG_TYPE_PIPE
	...
	CL_COMMAND_SVM_FREE             CL_command_type = C.CL_COMMAND_SVM_FREE
	CL_COMMAND_SVM_MEMCPY           CL_command_type = C.CL_COMMAND_SVM_MEMCPY
	CL_COMMAND_SVM_MEMFILL          CL_command_type = C.CL_COMMAND_SVM_MEMFILL
	CL_COMMAND_SVM_MAP              CL_command_type = C.CL_COMMAND_SVM_MAP
	...
	CL_PROFILING_COMMAND_COMPLETE CL_profiling_info = C.CL_PROFILING_COMMAND_COMPLETE
)
