...
const (
	...
	CL_INVALID_PIPE_SIZE               = -69 //C.CL_INVALID_PIPE_SIZE
	CL_INVALID_DEVICE_QUEUE            = -70 //C.CL_INVALID_DEVICE_QUEUE

	/* OpenCL Version */
	CL_VERSION_1_0 = C.CL_VERSION_1_0
	CL_VERSION_1_1 = C.CL_VERSION_1_1
	CL_VERSION_1_2 = C.CL_VERSION_1_2
	CL_VERSION_2_0 = 1 //C.CL_VERSION_2_0
	...
	CL_DEVICE_QUEUE_PROPERTIES              CL_device_info = C.CL_DEVICE_QUEUE_PROPERTIES /* deprecated */
	CL_DEVICE_QUEUE_ON_HOST_PROPERTIES      CL_device_info = 0x102A                       //C.CL_DEVICE_QUEUE_ON_HOST_PROPERTIES
	...
	CL_DEVICE_HOST_UNIFIED_MEMORY                  CL_device_info = C.CL_DEVICE_HOST_UNIFIED_MEMORY /* deprecated */
	...
	CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS            CL_device_info = 0x104C //C.CL_DEVICE_MAX_READ_WRITE_IMAGE_ARGS
	CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE             CL_device_info = 0x104D //C.CL_DEVICE_MAX_GLOBAL_VARIABLE_SIZE
	CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES           CL_device_info = 0x104E //C.CL_DEVICE_QUEUE_ON_DEVICE_PROPERTIES
	CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE       CL_device_info = 0x104F //C.CL_DEVICE_QUEUE_ON_DEVICE_PREFERRED_SIZE
	CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE             CL_device_info = 0x1050 //C.CL_DEVICE_QUEUE_ON_DEVICE_MAX_SIZE
	CL_DEVICE_MAX_ON_DEVICE_QUEUES                 CL_device_info = 0x1051 //C.CL_DEVICE_MAX_ON_DEVICE_QUEUES
	CL_DEVICE_MAX_ON_DEVICE_EVENTS                 CL_device_info = 0x1052 //C.CL_DEVICE_MAX_ON_DEVICE_EVENTS
	CL_DEVICE_SVM_CAPABILITIES                     CL_device_info = 0x1053 //C.CL_DEVICE_SVM_CAPABILITIES
	CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE CL_device_info = 0x1054 //C.CL_DEVICE_GLOBAL_VARIABLE_PREFERRED_TOTAL_SIZE
	CL_DEVICE_MAX_PIPE_ARGS                        CL_device_info = 0x1055 //C.CL_DEVICE_MAX_PIPE_ARGS
	CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS         CL_device_info = 0x1056 //C.CL_DEVICE_PIPE_MAX_ACTIVE_RESERVATIONS
	CL_DEVICE_PIPE_MAX_PACKET_SIZE                 CL_device_info = 0x1057 //C.CL_DEVICE_PIPE_MAX_PACKET_SIZE
	CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT  CL_device_info = 0x1058 //C.CL_DEVICE_PREFERRED_PLATFORM_ATOMIC_ALIGNMENT
	CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT    CL_device_info = 0x1059 //C.CL_DEVICE_PREFERRED_GLOBAL_ATOMIC_ALIGNMENT
	CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT     CL_device_info = 0x105A //C.CL_DEVICE_PREFERRED_LOCAL_ATOMIC_ALIGNMENT
	...
	CL_QUEUE_ON_DEVICE                     CL_command_queue_properties = (1 << 2) //C.CL_QUEUE_ON_DEVICE
	CL_QUEUE_ON_DEVICE_DEFAULT             CL_command_queue_properties = (1 << 3) //C.CL_QUEUE_ON_DEVICE_DEFAULT
	...
	CL_DEVICE_SVM_COARSE_GRAIN_BUFFER CL_device_svm_capabilities = (1 << 0) //C.CL_DEVICE_SVM_COARSE_GRAIN_BUFFER
	CL_DEVICE_SVM_FINE_GRAIN_BUFFER   CL_device_svm_capabilities = (1 << 1) //C.CL_DEVICE_SVM_FINE_GRAIN_BUFFER
	CL_DEVICE_SVM_FINE_GRAIN_SYSTEM   CL_device_svm_capabilities = (1 << 2) //C.CL_DEVICE_SVM_FINE_GRAIN_SYSTEM
	CL_DEVICE_SVM_ATOMICS             CL_device_svm_capabilities = (1 << 3) //C.CL_DEVICE_SVM_ATOMICS
	...
	CL_QUEUE_SIZE            CL_command_queue_info = 0x1094 //C.CL_QUEUE_SIZE
	...
	CL_MEM_SVM_FINE_GRAIN_BUFFER CL_mem_flags = (1 << 10) //C.CL_MEM_SVM_FINE_GRAIN_BUFFER /* used by cl_svm_mem_flags only */
	CL_MEM_SVM_ATOMICS           CL_mem_flags = (1 << 11) //C.CL_MEM_SVM_ATOMICS           /* used by cl_svm_mem_flags only */
	CL_MEM_KERNEL_READ_AND_WRITE CL_mem_flags = (1 << 12) //C.CL_MEM_KERNEL_READ_AND_WRITE
	...
	CL_sRGB          CL_channel_order = 0x10BF //C.CL_sRGB
	CL_sRGBx         CL_channel_order = 0x10C0 //C.CL_sRGBx
	CL_sRGBA         CL_channel_order = 0x10C1 //C.CL_sRGBA
	CL_sBGRA         CL_channel_order = 0x10C2 //C.CL_sBGRA
	CL_ABGR          CL_channel_order = 0x10C3 //C.CL_ABGR
	...
	CL_MEM_OBJECT_PIPE           CL_mem_object_type = 0x10F7 //C.CL_MEM_OBJECT_PIPE
	...
	CL_MEM_USES_SVM_POINTER     CL_mem_info = 0x1109 //C.CL_MEM_USES_SVM_POINTER
	...
	/* cl_pipe_info */
	CL_PIPE_PACKET_SIZE CL_pipe_info = 0x1120 //C.CL_PIPE_PACKET_SIZE
	CL_PIPE_MAX_PACKETS CL_pipe_info = 0x1121 //C.CL_PIPE_MAX_PACKETS
	...
	CL_SAMPLER_MIP_FILTER_MODE   CL_sampler_info = 0x1155 //C.CL_SAMPLER_MIP_FILTER_MODE
	CL_SAMPLER_LOD_MIN           CL_sampler_info = 0x1156 //C.CL_SAMPLER_LOD_MIN
	CL_SAMPLER_LOD_MAX           CL_sampler_info = 0x1157 //C.CL_SAMPLER_LOD_MAX
	...
	CL_PROGRAM_BUILD_GLOBAL_VARIABLE_TOTAL_SIZE CL_program_build_info = 0x1185 //C.CL_PROGRAM_BUILD_GLOBAL_VARIABLE_TOTAL_SIZE
	...
	CL_KERNEL_ARG_TYPE_PIPE     CL_kernel_arg_type_qualifier = (1 << 3) //C.CL_KERNEL_ARG_TYPE_PIPE
	...
	/* cl_kernel_exec_info */
	CL_KERNEL_EXEC_INFO_SVM_PTRS              CL_kernel_exec_info = 0x11B6 //C.CL_KERNEL_EXEC_INFO_SVM_PTRS
	CL_KERNEL_EXEC_INFO_SVM_FINE_GRAIN_SYSTEM CL_kernel_exec_info = 0x11B7 //C.CL_KERNEL_EXEC_INFO_SVM_FINE_GRAIN_SYSTEM
	...
	CL_COMMAND_SVM_FREE             CL_command_type = 0x1209 //C.CL_COMMAND_SVM_FREE
	CL_COMMAND_SVM_MEMCPY           CL_command_type = 0x120A //C.CL_COMMAND_SVM_MEMCPY
	CL_COMMAND_SVM_MEMFILL          CL_command_type = 0x120B //C.CL_COMMAND_SVM_MEMFILL
	CL_COMMAND_SVM_MAP              CL_command_type = 0x120C //C.CL_COMMAND_SVM_MAP
	CL_COMMAND_SVM_UNMAP            CL_command_type = 0x120D //C.CL_COMMAND_SVM_UNMAP
	...
	CL_PROFILING_COMMAND_COMPLETE CL_profiling_info = 0x1284 //C.CL_PROFILING_COMMAND_COMPLETE
)
