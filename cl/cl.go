...
const (
	...
	CL_FALSE        = C.CL_FALSE
	CL_TRUE         = C.CL_TRUE
	CL_BLOCKING     = C.CL_BLOCKING
	CL_NON_BLOCKING = C.CL_NON_BLOCKING
	...
	CL_FP_DENORM                        = C.CL_FP_DENORM
	CL_FP_INF_NAN                       = C.CL_FP_INF_NAN
	CL_FP_ROUND_TO_NEAREST              = C.CL_FP_ROUND_TO_NEAREST
	CL_FP_ROUND_TO_ZERO                 = C.CL_FP_ROUND_TO_ZERO
	CL_FP_ROUND_TO_INF                  = C.CL_FP_ROUND_TO_INF
	CL_FP_FMA                           = C.CL_FP_FMA
	CL_FP_SOFT_FLOAT                    = C.CL_FP_SOFT_FLOAT
	CL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT = C.CL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT

	/* cl_device_mem_cache_type */
	CL_NONE             = C.CL_NONE
	CL_READ_ONLY_CACHE  = C.CL_READ_ONLY_CACHE
	CL_READ_WRITE_CACHE = C.CL_READ_WRITE_CACHE

	/* cl_device_local_mem_type */
	CL_LOCAL  = C.CL_LOCAL
	CL_GLOBAL = C.CL_GLOBAL

	/* cl_device_exec_capabilities - bitfield */
	CL_EXEC_KERNEL        = C.CL_EXEC_KERNEL
	CL_EXEC_NATIVE_KERNEL = C.CL_EXEC_NATIVE_KERNEL

	/* cl_command_queue_properties - bitfield */
	CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE = C.CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE
	CL_QUEUE_PROFILING_ENABLE              = C.CL_QUEUE_PROFILING_ENABLE

	/* cl_context_info  */
	CL_CONTEXT_REFERENCE_COUNT = C.CL_CONTEXT_REFERENCE_COUNT
	CL_CONTEXT_DEVICES         = C.CL_CONTEXT_DEVICES
	CL_CONTEXT_PROPERTIES      = C.CL_CONTEXT_PROPERTIES
	CL_CONTEXT_NUM_DEVICES     = C.CL_CONTEXT_NUM_DEVICES

	/* cl_context_properties */
	CL_CONTEXT_PLATFORM          = C.CL_CONTEXT_PLATFORM
	CL_CONTEXT_INTEROP_USER_SYNC = C.CL_CONTEXT_INTEROP_USER_SYNC

	/* cl_device_partition_property */
	CL_DEVICE_PARTITION_EQUALLY            = C.CL_DEVICE_PARTITION_EQUALLY
	CL_DEVICE_PARTITION_BY_COUNTS          = C.CL_DEVICE_PARTITION_BY_COUNTS
	CL_DEVICE_PARTITION_BY_COUNTS_LIST_END = C.CL_DEVICE_PARTITION_BY_COUNTS_LIST_END
	CL_DEVICE_PARTITION_BY_AFFINITY_DOMAIN = C.CL_DEVICE_PARTITION_BY_AFFINITY_DOMAIN

	/* cl_device_affinity_domain */
	CL_DEVICE_AFFINITY_DOMAIN_NUMA               = C.CL_DEVICE_AFFINITY_DOMAIN_NUMA
	CL_DEVICE_AFFINITY_DOMAIN_L4_CACHE           = C.CL_DEVICE_AFFINITY_DOMAIN_L4_CACHE
	CL_DEVICE_AFFINITY_DOMAIN_L3_CACHE           = C.CL_DEVICE_AFFINITY_DOMAIN_L3_CACHE
	CL_DEVICE_AFFINITY_DOMAIN_L2_CACHE           = C.CL_DEVICE_AFFINITY_DOMAIN_L2_CACHE
	CL_DEVICE_AFFINITY_DOMAIN_L1_CACHE           = C.CL_DEVICE_AFFINITY_DOMAIN_L1_CACHE
	CL_DEVICE_AFFINITY_DOMAIN_NEXT_PARTITIONABLE = C.CL_DEVICE_AFFINITY_DOMAIN_NEXT_PARTITIONABLE

	/* cl_command_queue_info */
	CL_QUEUE_CONTEXT         = C.CL_QUEUE_CONTEXT
	CL_QUEUE_DEVICE          = C.CL_QUEUE_DEVICE
	CL_QUEUE_REFERENCE_COUNT = C.CL_QUEUE_REFERENCE_COUNT
	CL_QUEUE_PROPERTIES      = C.CL_QUEUE_PROPERTIES

	/* cl_mem_flags - bitfield */
	CL_MEM_READ_WRITE     = C.CL_MEM_READ_WRITE
	CL_MEM_WRITE_ONLY     = C.CL_MEM_WRITE_ONLY
	CL_MEM_READ_ONLY      = C.CL_MEM_READ_ONLY
	CL_MEM_USE_HOST_PTR   = C.CL_MEM_USE_HOST_PTR
	CL_MEM_ALLOC_HOST_PTR = C.CL_MEM_ALLOC_HOST_PTR
	CL_MEM_COPY_HOST_PTR  = C.CL_MEM_COPY_HOST_PTR
	...
	CL_MIGRATE_MEM_OBJECT_HOST              = C.CL_MIGRATE_MEM_OBJECT_HOST
	CL_MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED = C.CL_MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED
	...
	CL_BGRA          = C.CL_BGRA
	CL_ARGB          = C.CL_ARGB
	CL_INTENSITY     = C.CL_INTENSITY
	CL_LUMINANCE     = C.CL_LUMINANCE
	CL_Rx            = C.CL_Rx
	CL_RGx           = C.CL_RGx
	CL_RGBx          = C.CL_RGBx
	CL_DEPTH         = C.CL_DEPTH
	CL_DEPTH_STENCIL = C.CL_DEPTH_STENCIL

	/* cl_channel_type */
	CL_SNORM_INT8       = C.CL_SNORM_INT8
	CL_SNORM_INT16      = C.CL_SNORM_INT16
	CL_UNORM_INT8       = C.CL_UNORM_INT8
	CL_UNORM_INT16      = C.CL_UNORM_INT16
	CL_UNORM_SHORT_565  = C.CL_UNORM_SHORT_565
	CL_UNORM_SHORT_555  = C.CL_UNORM_SHORT_555
	CL_UNORM_INT_101010 = C.CL_UNORM_INT_101010
	CL_SIGNED_INT8      = C.CL_SIGNED_INT8
	CL_SIGNED_INT16     = C.CL_SIGNED_INT16
	CL_SIGNED_INT32     = C.CL_SIGNED_INT32
	CL_UNSIGNED_INT8    = C.CL_UNSIGNED_INT8
	CL_UNSIGNED_INT16   = C.CL_UNSIGNED_INT16
	CL_UNSIGNED_INT32   = C.CL_UNSIGNED_INT32
	CL_HALF_FLOAT       = C.CL_HALF_FLOAT
	CL_FLOAT            = C.CL_FLOAT
	CL_UNORM_INT24      = C.CL_UNORM_INT24

	/* cl_mem_object_type */
	CL_MEM_OBJECT_BUFFER         = C.CL_MEM_OBJECT_BUFFER
	CL_MEM_OBJECT_IMAGE2D        = C.CL_MEM_OBJECT_IMAGE2D
	CL_MEM_OBJECT_IMAGE3D        = C.CL_MEM_OBJECT_IMAGE3D
	CL_MEM_OBJECT_IMAGE2D_ARRAY  = C.CL_MEM_OBJECT_IMAGE2D_ARRAY
	CL_MEM_OBJECT_IMAGE1D        = C.CL_MEM_OBJECT_IMAGE1D
	CL_MEM_OBJECT_IMAGE1D_ARRAY  = C.CL_MEM_OBJECT_IMAGE1D_ARRAY
	CL_MEM_OBJECT_IMAGE1D_BUFFER = C.CL_MEM_OBJECT_IMAGE1D_BUFFER

	/* cl_mem_info */
	CL_MEM_TYPE                 = C.CL_MEM_TYPE
	CL_MEM_FLAGS                = C.CL_MEM_FLAGS
	CL_MEM_SIZE                 = C.CL_MEM_SIZE
	CL_MEM_HOST_PTR             = C.CL_MEM_HOST_PTR
	CL_MEM_MAP_COUNT            = C.CL_MEM_MAP_COUNT
	CL_MEM_REFERENCE_COUNT      = C.CL_MEM_REFERENCE_COUNT
	CL_MEM_CONTEXT              = C.CL_MEM_CONTEXT
	CL_MEM_ASSOCIATED_MEMOBJECT = C.CL_MEM_ASSOCIATED_MEMOBJECT
	CL_MEM_OFFSET               = C.CL_MEM_OFFSET

	/* cl_image_info */
	CL_IMAGE_FORMAT         = C.CL_IMAGE_FORMAT
	CL_IMAGE_ELEMENT_SIZE   = C.CL_IMAGE_ELEMENT_SIZE
	CL_IMAGE_ROW_PITCH      = C.CL_IMAGE_ROW_PITCH
	CL_IMAGE_SLICE_PITCH    = C.CL_IMAGE_SLICE_PITCH
	CL_IMAGE_WIDTH          = C.CL_IMAGE_WIDTH
	CL_IMAGE_HEIGHT         = C.CL_IMAGE_HEIGHT
	CL_IMAGE_DEPTH          = C.CL_IMAGE_DEPTH
	CL_IMAGE_ARRAY_SIZE     = C.CL_IMAGE_ARRAY_SIZE
	CL_IMAGE_BUFFER         = C.CL_IMAGE_BUFFER
	CL_IMAGE_NUM_MIP_LEVELS = C.CL_IMAGE_NUM_MIP_LEVELS
	CL_IMAGE_NUM_SAMPLES    = C.CL_IMAGE_NUM_SAMPLES

	/* cl_addressing_mode */
	CL_ADDRESS_NONE            = C.CL_ADDRESS_NONE
	CL_ADDRESS_CLAMP_TO_EDGE   = C.CL_ADDRESS_CLAMP_TO_EDGE
	CL_ADDRESS_CLAMP           = C.CL_ADDRESS_CLAMP
	CL_ADDRESS_REPEAT          = C.CL_ADDRESS_REPEAT
	CL_ADDRESS_MIRRORED_REPEAT = C.CL_ADDRESS_MIRRORED_REPEAT

	/* cl_filter_mode */
	CL_FILTER_NEAREST = C.CL_FILTER_NEAREST
	CL_FILTER_LINEAR  = C.CL_FILTER_LINEAR

	/* cl_sampler_info */
	CL_SAMPLER_REFERENCE_COUNT   = C.CL_SAMPLER_REFERENCE_COUNT
	CL_SAMPLER_CONTEXT           = C.CL_SAMPLER_CONTEXT
	CL_SAMPLER_NORMALIZED_COORDS = C.CL_SAMPLER_NORMALIZED_COORDS
	CL_SAMPLER_ADDRESSING_MODE   = C.CL_SAMPLER_ADDRESSING_MODE
	CL_SAMPLER_FILTER_MODE       = C.CL_SAMPLER_FILTER_MODE

	/* cl_map_flags - bitfield */
	CL_MAP_READ                    = C.CL_MAP_READ
	CL_MAP_WRITE                   = C.CL_MAP_WRITE
	CL_MAP_WRITE_INVALIDATE_REGION = C.CL_MAP_WRITE_INVALIDATE_REGION

	/* cl_program_info */
	CL_PROGRAM_REFERENCE_COUNT = C.CL_PROGRAM_REFERENCE_COUNT
	CL_PROGRAM_CONTEXT         = C.CL_PROGRAM_CONTEXT
	CL_PROGRAM_NUM_DEVICES     = C.CL_PROGRAM_NUM_DEVICES
	CL_PROGRAM_DEVICES         = C.CL_PROGRAM_DEVICES
	CL_PROGRAM_SOURCE          = C.CL_PROGRAM_SOURCE
	CL_PROGRAM_BINARY_SIZES    = C.CL_PROGRAM_BINARY_SIZES
	CL_PROGRAM_BINARIES        = C.CL_PROGRAM_BINARIES
	CL_PROGRAM_NUM_KERNELS     = C.CL_PROGRAM_NUM_KERNELS
	CL_PROGRAM_KERNEL_NAMES    = C.CL_PROGRAM_KERNEL_NAMES

	/* cl_program_build_info */
	CL_PROGRAM_BUILD_STATUS  = C.CL_PROGRAM_BUILD_STATUS
	CL_PROGRAM_BUILD_OPTIONS = C.CL_PROGRAM_BUILD_OPTIONS
	CL_PROGRAM_BUILD_LOG     = C.CL_PROGRAM_BUILD_LOG
	CL_PROGRAM_BINARY_TYPE   = C.CL_PROGRAM_BINARY_TYPE

	/* cl_program_binary_type */
	CL_PROGRAM_BINARY_TYPE_NONE            = C.CL_PROGRAM_BINARY_TYPE_NONE
	CL_PROGRAM_BINARY_TYPE_COMPILED_OBJECT = C.CL_PROGRAM_BINARY_TYPE_COMPILED_OBJECT
	CL_PROGRAM_BINARY_TYPE_LIBRARY         = C.CL_PROGRAM_BINARY_TYPE_LIBRARY
	CL_PROGRAM_BINARY_TYPE_EXECUTABLE      = C.CL_PROGRAM_BINARY_TYPE_EXECUTABLE

	/* cl_build_status */
	CL_BUILD_SUCCESS     = C.CL_BUILD_SUCCESS
	CL_BUILD_NONE        = C.CL_BUILD_NONE
	CL_BUILD_ERROR       = C.CL_BUILD_ERROR
	CL_BUILD_IN_PROGRESS = C.CL_BUILD_IN_PROGRESS

	/* cl_kernel_info */
	CL_KERNEL_FUNCTION_NAME   = C.CL_KERNEL_FUNCTION_NAME
	CL_KERNEL_NUM_ARGS        = C.CL_KERNEL_NUM_ARGS
	CL_KERNEL_REFERENCE_COUNT = C.CL_KERNEL_REFERENCE_COUNT
	CL_KERNEL_CONTEXT         = C.CL_KERNEL_CONTEXT
	CL_KERNEL_PROGRAM         = C.CL_KERNEL_PROGRAM
	CL_KERNEL_ATTRIBUTES      = C.CL_KERNEL_ATTRIBUTES

	/* cl_kernel_arg_info */
	CL_KERNEL_ARG_ADDRESS_QUALIFIER = C.CL_KERNEL_ARG_ADDRESS_QUALIFIER
	CL_KERNEL_ARG_ACCESS_QUALIFIER  = C.CL_KERNEL_ARG_ACCESS_QUALIFIER
	CL_KERNEL_ARG_TYPE_NAME         = C.CL_KERNEL_ARG_TYPE_NAME
	CL_KERNEL_ARG_TYPE_QUALIFIER    = C.CL_KERNEL_ARG_TYPE_QUALIFIER
	CL_KERNEL_ARG_NAME              = C.CL_KERNEL_ARG_NAME

	/* cl_kernel_arg_address_qualifier */
	CL_KERNEL_ARG_ADDRESS_GLOBAL   = C.CL_KERNEL_ARG_ADDRESS_GLOBAL
	CL_KERNEL_ARG_ADDRESS_LOCAL    = C.CL_KERNEL_ARG_ADDRESS_LOCAL
	CL_KERNEL_ARG_ADDRESS_CONSTANT = C.CL_KERNEL_ARG_ADDRESS_CONSTANT
	CL_KERNEL_ARG_ADDRESS_PRIVATE  = C.CL_KERNEL_ARG_ADDRESS_PRIVATE

	/* cl_kernel_arg_access_qualifier */
	CL_KERNEL_ARG_ACCESS_READ_ONLY  = C.CL_KERNEL_ARG_ACCESS_READ_ONLY
	CL_KERNEL_ARG_ACCESS_WRITE_ONLY = C.CL_KERNEL_ARG_ACCESS_WRITE_ONLY
	CL_KERNEL_ARG_ACCESS_READ_WRITE = C.CL_KERNEL_ARG_ACCESS_READ_WRITE
	CL_KERNEL_ARG_ACCESS_NONE       = C.CL_KERNEL_ARG_ACCESS_NONE

	/* cl_kernel_arg_type_qualifer */
	CL_KERNEL_ARG_TYPE_NONE     = C.CL_KERNEL_ARG_TYPE_NONE
	CL_KERNEL_ARG_TYPE_CONST    = C.CL_KERNEL_ARG_TYPE_CONST
	CL_KERNEL_ARG_TYPE_RESTRICT = C.CL_KERNEL_ARG_TYPE_RESTRICT
	CL_KERNEL_ARG_TYPE_VOLATILE = C.CL_KERNEL_ARG_TYPE_VOLATILE

	/* cl_kernel_work_group_info */
	CL_KERNEL_WORK_GROUP_SIZE                    = C.CL_KERNEL_WORK_GROUP_SIZE
	CL_KERNEL_COMPILE_WORK_GROUP_SIZE            = C.CL_KERNEL_COMPILE_WORK_GROUP_SIZE
	CL_KERNEL_LOCAL_MEM_SIZE                     = C.CL_KERNEL_LOCAL_MEM_SIZE
	CL_KERNEL_PREFERRED_WORK_GROUP_SIZE_MULTIPLE = C.CL_KERNEL_PREFERRED_WORK_GROUP_SIZE_MULTIPLE
	CL_KERNEL_PRIVATE_MEM_SIZE                   = C.CL_KERNEL_PRIVATE_MEM_SIZE
	CL_KERNEL_GLOBAL_WORK_SIZE                   = C.CL_KERNEL_GLOBAL_WORK_SIZE

	/* cl_event_info  */
	CL_EVENT_COMMAND_QUEUE            = C.CL_EVENT_COMMAND_QUEUE
	CL_EVENT_COMMAND_TYPE             = C.CL_EVENT_COMMAND_TYPE
	CL_EVENT_REFERENCE_COUNT          = C.CL_EVENT_REFERENCE_COUNT
	CL_EVENT_COMMAND_EXECUTION_STATUS = C.CL_EVENT_COMMAND_EXECUTION_STATUS
	CL_EVENT_CONTEXT                  = C.CL_EVENT_CONTEXT

	/* cl_command_type */
	CL_COMMAND_NDRANGE_KERNEL       = C.CL_COMMAND_NDRANGE_KERNEL
	CL_COMMAND_TASK                 = C.CL_COMMAND_TASK
	CL_COMMAND_NATIVE_KERNEL        = C.CL_COMMAND_NATIVE_KERNEL
	CL_COMMAND_READ_BUFFER          = C.CL_COMMAND_READ_BUFFER
	CL_COMMAND_WRITE_BUFFER         = C.CL_COMMAND_WRITE_BUFFER
	CL_COMMAND_COPY_BUFFER          = C.CL_COMMAND_COPY_BUFFER
	CL_COMMAND_READ_IMAGE           = C.CL_COMMAND_READ_IMAGE
	CL_COMMAND_WRITE_IMAGE          = C.CL_COMMAND_WRITE_IMAGE
	CL_COMMAND_COPY_IMAGE           = C.CL_COMMAND_COPY_IMAGE
	CL_COMMAND_COPY_IMAGE_TO_BUFFER = C.CL_COMMAND_COPY_IMAGE_TO_BUFFER
	CL_COMMAND_COPY_BUFFER_TO_IMAGE = C.CL_COMMAND_COPY_BUFFER_TO_IMAGE
	CL_COMMAND_MAP_BUFFER           = C.CL_COMMAND_MAP_BUFFER
	CL_COMMAND_MAP_IMAGE            = C.CL_COMMAND_MAP_IMAGE
	CL_COMMAND_UNMAP_MEM_OBJECT     = C.CL_COMMAND_UNMAP_MEM_OBJECT
	CL_COMMAND_MARKER               = C.CL_COMMAND_MARKER
	CL_COMMAND_ACQUIRE_GL_OBJECTS   = C.CL_COMMAND_ACQUIRE_GL_OBJECTS
	CL_COMMAND_RELEASE_GL_OBJECTS   = C.CL_COMMAND_RELEASE_GL_OBJECTS
	CL_COMMAND_READ_BUFFER_RECT     = C.CL_COMMAND_READ_BUFFER_RECT
	CL_COMMAND_WRITE_BUFFER_RECT    = C.CL_COMMAND_WRITE_BUFFER_RECT
	CL_COMMAND_COPY_BUFFER_RECT     = C.CL_COMMAND_COPY_BUFFER_RECT
	CL_COMMAND_USER                 = C.CL_COMMAND_USER
	CL_COMMAND_BARRIER              = C.CL_COMMAND_BARRIER
	CL_COMMAND_MIGRATE_MEM_OBJECTS  = C.CL_COMMAND_MIGRATE_MEM_OBJECTS
	CL_COMMAND_FILL_BUFFER          = C.CL_COMMAND_FILL_BUFFER
	CL_COMMAND_FILL_IMAGE           = C.CL_COMMAND_FILL_IMAGE
	...
	CL_BUFFER_CREATE_TYPE_REGION = C.CL_BUFFER_CREATE_TYPE_REGION

	/* cl_profiling_info  */
	CL_PROFILING_COMMAND_QUEUED = C.CL_PROFILING_COMMAND_QUEUED
	CL_PROFILING_COMMAND_SUBMIT = C.CL_PROFILING_COMMAND_SUBMIT
	CL_PROFILING_COMMAND_START  = C.CL_PROFILING_COMMAND_START
	CL_PROFILING_COMMAND_END    = C.CL_PROFILING_COMMAND_END
)
